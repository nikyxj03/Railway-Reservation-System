...
{
	$conn = mysqli_connect("localhost:3307","root","","railway");
if(!$conn){  
...
$email=$_POST['email'];
$pw=$_POST['pw'];
$sql = "SELECT * FROM staff WHERE s_mail = '$email' AND s_pass = '$pw';";
...
<style type="text/css">
	...
	html { 
		background: url(img/bg23.jpg) no-repeat center center fixed; 
...
<body>
	...
	<div id="loginarea">
	<form id="login" action="staff.php" onsubmit="return validate()" method="post" name="login">
	<div id="logintext">Staff Login to Indian Railways!</div><br/><br/>
	<table>
